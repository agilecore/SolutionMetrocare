...
namespace Metrocare.Domain
{
    ...
    /// </summary>
    public class DependenteBus
    {
        private DependenteRep   _repositorio { get; set; }
        private bool _saveLastGetByFilter { get; set; }

        /// <summary>
        /// Construtor.
        /// </summary>
        public DependenteBus()
        {
            _repositorio = new DependenteRep();
        }
        ...
        public DependenteDto GetItem(DependenteFilter filter)
        {
        ...
        /// </summary>
        /// <param name="model">Objeto a ser salvo.</param>
        public DependenteDto AddGetItem(DependenteDto model)
        {
            var result = _repositorio.Add(model);
        ...
        /// </summary>
        /// <param name="filter">Objeto filter.</param>
        public List<DependenteDto> GetByFilter(DependenteFilter filter)
        {                   
        ...
        public List<DependenteDto> GetByFilter(DependenteFilter filter, bool saveLastGetByFilter)
        {
