...
namespace Metrocare.Domain
{
    ...
    {
        private PrestadorRep   _repositorio { get; set; }
        ...
        public PrestadorDto GetItem(PrestadorFilter filter)
        {
        ...
        /// </summary>
        /// <param name="model">Objeto a ser salvo.</param>
        public PrestadorDto AddGetItem(PrestadorDto model)
        {
            var result = _repositorio.Add(model);
        ...
        /// </summary>
        /// <param name="filter">Objeto filter.</param>
        public List<PrestadorDto> GetByFilter(PrestadorFilter filter)
        {                   
        ...
        public List<PrestadorDto> GetByFilter(PrestadorFilter filter, bool saveLastGetByFilter)
        {
