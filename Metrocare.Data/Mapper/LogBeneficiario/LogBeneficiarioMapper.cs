...
{
    public class LogBeneficiarioMapper : EntityTypeConfiguration<LogBeneficiarioDto>
    {
        public LogBeneficiarioMapper()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("MC_LOG_BENEFICIARIO", "dbo");

            // Propertys Relationship Database Table Columns
            this.Property(_ => _.ID).HasColumnName("ID_LOG_BENEFICIARIO");
