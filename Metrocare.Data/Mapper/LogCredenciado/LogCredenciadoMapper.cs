...
{
    public class LogCredenciadoMapper : EntityTypeConfiguration<LogCredenciadoDto>
    {
        public LogCredenciadoMapper()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("MC_LOG_CREDENCIADO", "dbo");

            // Propertys Relationship Database Table Columns
            this.Property(_ => _.ID).HasColumnName("ID_LOG_CREDENCIADO");
