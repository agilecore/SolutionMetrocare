...
{
    public class BeneficiarioMapper : EntityTypeConfiguration<BeneficiarioDto>
    {
        public BeneficiarioMapper()
        {
            ...
            this.Property(_ => _.TELEFONE).IsRequired().HasMaxLength(30);
            this.Property(_ => _.CELULAR).IsRequired().HasMaxLength(30);
            ...
            this.ToTable("MC_BENEFICIARIO", "dbo");

            // Propertys Relationship Database Table Columns
            this.Property(_ => _.ID).HasColumnName("ID_BENEFICIARIO");
