...
namespace Metrocare.Generator.Connections
{
    public class ConnectionOleDb : IDisposable
    {
        ...
        public ConnectionOleDb(String Query, String LocalConnectionString)
        {
            ...
            this.ConnectionDb = new OleDbConnection(LocalConnectionString);
            this.CommandSql = new OleDbCommand(this.LocalQuery, ConnectionDb);
        ...
        public void Parameter(String Name, String Value)
        {
           // this.CommandSql.Parameters.AddWithValue(Name, Value);
            this.CommandSql.Parameters.Add(Name, Value); // Only namespace 'OleDb.DataAccess.Client'
        }
        ...
        public DataSet GetDataSet()
        {
            ...
            OleDbDataAdapter Da = new OleDbDataAdapter(this.LocalQuery, this.ConnectionDb);
            Da.Fill(Ds);
        ...
        {
            this.ConnectionDb.Open();
            this.CommandSql = new OleDbCommand(this.LocalQuery, this.ConnectionDb);
